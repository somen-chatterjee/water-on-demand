...
import 'package:water_on_demand/ui/cart/cart_screen.dart';
...
class BaseAppBarBg extends StatefulWidget {
  const BaseAppBarBg({super.key,});

  @override
  State<BaseAppBarBg> createState() => _BaseAppBarBgState();
}

class _BaseAppBarBgState extends State<BaseAppBarBg> {
                ...
                children: [
                    ...
                    return Expanded(
                      child: controller.isProfileLoading.value
                        ...
                        children: [
                          ...
                          BaseText(
                            value: controller.profileData!.fullName.toString(),
                            fontSize: 17,
                            fontWeight: FontWeight.w600,
                          ),
                          if(controller.profileData != null && controller.profileData!.addressData != null)
                          InkWell(
                            splashColor: Colors.transparent,
                            highlightColor: Colors.transparent,
                            onTap: () {
                              controller.getUserAddressList(context: context);
                            },
                            child: Row(
                              children: [
                                Flexible(
                  ...
                  Row(
                    ...
                    children: [
                      GestureDetector(
                        onTap: () {
                          Get.to(() => const CartScreen(purchaseType: 601,));
                        },
                        child: Image.asset(
                          width: 50,
                          height: 50,
                          BaseAssets.cartWithBg,
                        ),
                      ),
                      GestureDetector(
                        onTap: () {
